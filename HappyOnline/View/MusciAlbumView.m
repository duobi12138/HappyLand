...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        backgroudLayer.contents = (id)[UIImage imageNamed:@"music_cover.png"].CGImage;
        ...
        _album.layer.cornerRadius = 10; // 设置为圆形
...
- (void)startAnimation:(CGFloat)rate {
    ...
    [self initMusicNotoAnimation:@"musicnote1.2.png" delayTime:0.0f rate:rate];
    [self initMusicNotoAnimation:@"musicnote2.2.png" delayTime:1.0f rate:rate];
    [self initMusicNotoAnimation:@"musicnote1.2.png" delayTime:2.0f rate:rate];
...
- (void)resetView {
    ...
    [_albumContainer.layer removeAllAnimations];
}
